...
SECRET_KEY = 'django-insecure-2_^yx*9try0xn+3-um#gqz9wa_+0s-5i^$)j&2wkd**&htt4i3'
...
TEMPLATES = [
    {
        ...
        'DIRS': [# Aqui definimos la carpeta donde ira a buscar el template nuestras aplicaciones.
